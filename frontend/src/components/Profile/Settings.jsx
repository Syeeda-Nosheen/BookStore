...
const Settings = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
        ...
        setValue({address: response.data.address});// Set data here to trigger re-render
      } ;
    
    fetch();
  }, []);
  const submitAddress = async () => {
    const response = await axios.put("hthttps://bookheaven-2.onrender.com/api/v1/update-address",Value,{headers});
  ...
  return (
    ...
    {ProfileData && (
        <div className='h-[100%] p-0 p-4 text-zinc-100'>
