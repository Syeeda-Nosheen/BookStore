...
const Sidebar = ({data}) => {
  ...
  return (
    <div className='bg-zinc-800 p-4 rounded flex flex-col items-center justify-between h-auto lg:h-[100%]'>
      ...
      <img src="https://www.pngarts.com/files/10/Default-Profile-Picture-PNG-Free-Download.png" className='h-[12vh]' />
      ...
      {role === "admin" && (
        ...
        <button className='bg-zinc-900 w-3/6 lg:w-full mt-4 lg:mt-4 text-white font-semibold flex items-center justify-center py-2 rounded hover:bg-white hover:text-zinc-900 transition-all duration-300'
        onClick={() => {
