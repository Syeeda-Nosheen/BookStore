...
const Cart = () => {
  ...
  const [Cart, setCart] = useState(null); // Initialize as null to trigger the loader
          ...
          {Cart.map((items, i) => (
            <div className='w-full my-4 rounded flex flex-col md:flex-row p-4 bg-zinc-800 justify-between items-center' key={i}>
              ...
              <div className='w-full md:w-auto'>
                <h1 className='text-3xl font-semibold text-zinc-100 m1-2 md:mt-0'>{items.title}</h1>
